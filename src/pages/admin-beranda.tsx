...
export default function AdminBeranda() {
	...
	return (
		<div className="container">
			<div className="row mt-3 mb-md-5 mb-lg-3 primeCol">
			...
			<div className="row mt-5">
				...
				<div className="col-md-3 mt-1 mt-lg-0 mt-md-5 primeCol">
					<div
						className="shadow bg-wite curs boRad text-left m-3 m-md-0 mb-md-3 p-4 p-md-3 p-lg-4 d-flex justify-content-between"
					...
					<div
						className="shadow bg-white curs boRad text-left m-3 m-md-0 p-4 p-md-3 p-lg-4 d-flex justify-content-between"
